...
string kard(string k, string s)
{
    ...
    for (int i = 0; i < 7; i++)
    {
        for (int j = 0; j < 9; j++)
        {
            ...
            else if (0 < i < 6 && 0 < j < 8) arr[i][j] = " ";
            else if (i == 6 && j == 0) arr[i][j] = char(191);
            else if (i == 0 && j == 8) arr[i][j] = char(192);
            else if (i == 6 && j == 8) arr[i][j] = char(217);
            else if (i == 0 && 0 < j < 8) arr[i][j] = char(179);
            else if (i == 6 && 0 < j < 8) arr[i][j] = char(179);
            else if (0 < i < 6 && j == 0) arr[i][j] = char(196);
            else if (0 < i < 6 && j == 8) arr[i][j] = char(196);
        }
    }
